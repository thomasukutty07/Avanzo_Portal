    ...
    <TeamLeadChrome>
      <div className="p-4 md:p-8 space-y-10 animate-in fade-in duration-700 font-sans">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          <header>
            <h2 className="text-2xl font-black tracking-tight text-slate-900 font-headline leading-none">Team Communications</h2>
            <p className="text-xs font-bold text-slate-400 mt-2 font-headline leading-none opacity-60">Broadcast critical strategic updates and sector alerts</p>
          </header>
        ...
        <div className="flex flex-col md:flex-row gap-5">
          <div className="relative flex-1 group">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-100 rounded-2xl pl-16 pr-6 py-4 text-[13px] font-bold text-slate-900 focus:ring-4 focus:ring-violet-600/5 focus:border-violet-200 transition-all placeholder:text-slate-200 outline-none shadow-sm shadow-slate-200/10 tracking-tight"
            />
          </div>
          <select className="bg-white border border-slate-100 rounded-2xl px-6 py-4 text-[10px] font-black text-slate-700 min-w-[200px] shadow-sm focus:ring-4 focus:ring-violet-600/5 outline-none cursor-pointer uppercase tracking-widest">
        ...
        <div className="space-y-8">
          {loading ? (
             ...
             <div className="py-32 text-center opacity-30 text-[11px] font-black uppercase tracking-widest text-slate-300">
