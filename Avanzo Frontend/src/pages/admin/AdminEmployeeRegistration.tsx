                ...
                <CardContent className="p-8 md:p-12 space-y-10">
                    ...
                    {step === 'job' && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left animate-in slide-in-from-right-4 duration-500">
                            ...
                            <FormField label="Work Email" placeholder="john.doe@company.com" type="email" error={errors.email} value={formData.email} onChange={(v) => updateForm('email', v)} />
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                  <select 
                                    className={`w-full h-11 bg-slate-50 border-transparent rounded-xl px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-violet-600/20 focus:bg-white focus:border-violet-100 transition-all outline-none appearance-none cursor-pointer ${errors.department ? 'ring-2 ring-red-500/20 border-red-200 bg-red-50/10' : ''}`}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                  <select 
                                    className={`w-full h-11 bg-slate-50 border-transparent rounded-xl px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-violet-600/20 focus:bg-white focus:border-violet-100 transition-all outline-none appearance-none cursor-pointer ${errors.designation ? 'ring-2 ring-red-500/20 border-red-200 bg-red-50/10' : ''}`}
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                <div className="relative">
                                  <select 
                                    className="w-full h-11 bg-slate-50 border-transparent rounded-xl px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-violet-600/20 focus:bg-white focus:border-violet-100 transition-all outline-none appearance-none cursor-pointer"
                    ...
                    {step === 'security' && (
                        <div className="grid grid-cols-1 gap-8 text-left animate-in slide-in-from-right-4 duration-500 h-[280px]">
                            <div className="space-y-2">
                               <h3 className="text-sm font-bold text-slate-900 border-b border-slate-100 pb-2 flex items-center gap-2"><ShieldCheck className="text-emerald-500 size-4" /> Account Security</h3>
                            </div>
                            <div className="space-y-2">
                                <label className="text-[13px] font-bold text-slate-700 ml-1">Access Role & Permission</label>
                                <div className="relative">
                                  <select 
                                    className={`w-full h-11 bg-slate-50 border-transparent rounded-xl px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-violet-600/20 focus:bg-white focus:border-violet-100 transition-all outline-none appearance-none cursor-pointer ${errors.accessRole ? 'ring-2 ring-red-500/20 border-red-200 bg-red-50/10' : ''}`}
